...
[MyBatis](https://blog.csdn.net/rc4gyyc/article/details/136588695)

[MyBatis学习文档](https://b11et3un53m.feishu.cn/wiki/PsyawI04ei2FQykqfcPcmd7Dnsc)
...
![在这里插入图片描述](http://stofu80ry.sabkt.gdipper.com/picture/270c69c4169741ba800daab02bc204e7.png)
...
即可为当前实体类在编译期设置对应的get/set方法，构造方法，toString方法，hashCode方法，equals.方法等

```java
@NoArgsConstructor（用于无参构造）
@AllArgsConstructor
@Data
```
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987774-62.png)

然后用你的IDEA工具打开，项目结构如下：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987751-1.png)

注意配置一下项目的JDK版本为JDK11。首先点击项目结构设置：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987751-2.png)

在弹窗中配置JDK：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987751-3.png)

接下来，要导入两张表，在课前资料中已经提供了SQL文件：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987752-4.png)

对应的数据库表结构如下：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987752-5.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987752-6.png)

因此我们自定义的Mapper只要实现了这个`BaseMapper`，就无需自己实现单表CRUD了。 修改mp-demo中的`com.itheima.mp.mapper`包下的`UserMapper`接口，让其继承`BaseMapper`：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987752-7.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987752-8.png)
...
| ASSIGN_ID     | 分配 ID(主键类型为 Number(Long 和 Integer)或 String)(since 3.3.0),使用接口IdentifierGenerator的方法nextId(默认实现类为DefaultIdentifierGenerator**雪花算法**) |
...
### [更多注解](https://baomidou.com/reference/annotation/#tablename)

## 常见配置

MybatisPlus也支持基于yaml文件的自定义配置，详见官方文档：

[https://www.baomidou.com/reference/](https://www.baomidou.com/reference/)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987752-9.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987752-10.png)

参数中的`Wrapper`就是条件构造的抽象类，其下有很多默认实现，继承关系如图：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987752-11.png)

`Wrapper`的子类`AbstractWrapper`提供了where中包含的所有条件构造方法：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987752-12.png)

而QueryWrapper在AbstractWrapper的基础上拓展了一个select方法，允许指定查询字段：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987752-13.png)

而UpdateWrapper在AbstractWrapper的基础上拓展了一个set方法，允许指定SQL中的SET部分：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987752-14.png)
...
用Wrapper实现where语句，其他的在持久层用自定义SQL实现

在演示UpdateWrapper的案例中，我们在代码中编写了更新的SQL语句：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-15.png)

这种写法在某些企业也是不允许的，因为**SQL语句最好都维护在持久层，而不是业务层**。就当前案例来说，由于条件是in语句，只能将SQL写在Mapper.xml文件，利用foreach来生成动态SQL。 这实在是太麻烦了。假如查询条件更复杂，动态SQL的编写也会更加复杂。
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-16.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-17.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-18.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-19.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-20.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-21.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-22.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-23.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-24.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-25.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-26.png)

在`ClientPreparedStatement`的`executeBatchInternal`中，有判断`rewriteBatchedStatements`值是否为true并重写SQL的功能：

最终，SQL被重写了：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987753-27.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-28.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-29.png)

在弹出的窗口中填写数据库连接的基本信息：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-30.png)

点击OK保存。

然后再次点击Idea顶部菜单中的other，然后选择`Code Generator`:

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-31.png)

在弹出的表单中填写信息：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-32.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-33.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-34.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-35.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-36.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-37.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-38.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-39.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-40.png)

要让`MybatisPlus`处理枚举与数据库类型自动转换，我们必须告诉`MybatisPlus`，枚举中的哪个字段的值作为数据库值。 `MybatisPlus`提供了`@EnumValue`注解来标记枚举属性：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-41.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-42.png)

同时，为了使页面查询结果也是枚举格式，我们需要修改UserVO中的status属性：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987754-43.png)

并且，在UserStatus枚举中通过`@JsonValue`注解标记JSON序列化时展示的字段：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-44.png)

最后，在页面查询，结果如下：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-45.png)

## **3.4.****JSON****类型处理器**

数据库的user表中有一个`info`字段，是JSON类型：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-46.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-47.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-48.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-49.png)

同时，在User类上添加一个注解，声明自动映射：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-50.png)

测试可以发现，所有数据都正确封装到UserInfo当中了：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-51.png)

同时，为了让页面返回的结果也以对象格式返回，我们要修改UserVO中的info字段：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-52.png)

此时，在页面查询结果如下：

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-53.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-54.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-55.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-56.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987755-57.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987756-58.png)

最后，则是分页实体PageDTO:

![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987756-59.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987756-60.png)
...
![img](http://stofu80ry.sabkt.gdipper.com/picture/1737096987756-61.png)
